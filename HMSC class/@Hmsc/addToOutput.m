function p = addToOutput(m,beta,gamma,sigma,rho,iV,lambda,eta,alpha,ph,nf,lambdas,etas,nfs,betav,qv,psijh,delta,psijhs,deltas,covScale,sCovScale,vCovScale,factorCovScale)
p = HmscPar();
